...
# AF: TODO: Видимо, убрал это. Слишком сложно. Для `context_when` тыщу лет как существует
#   простая Proc-форма, которая сама подсказывает, как ей пользоваться. Незачем усложнять!
